...
use HulkApps\ShopifyApp\ShopifyApp;
...
class ShopifyAppTest extends TestCase
{
    ...
    {
        $this->assertEquals(\HulkApps\BasicShopifyAPI::class, get_class($this->shopifyApp->api()));
    }
    ...
    public function testShouldUseDefaultModel()
    {
        ...
        $this->assertEquals(\HulkApps\ShopifyApp\Models\Shop::class, get_class($shop));
    }
    ...
    public function testShouldAllowForModelOverride()
    {
        $shop = factory(Shop::class)->create();
        Session::put('shopify_domain', $shop->shopify_domain);
        Config::set('shopify-app.shop_model', \HulkApps\ShopifyApp\Test\Stubs\ShopModelStub::class);

        $shop = $this->shopifyApp->shop();

        $this->assertEquals(\HulkApps\ShopifyApp\Test\Stubs\ShopModelStub::class, get_class($shop));
