...
namespace HulkApps\ShopifyApp\Services;
...
class BillingPlan
{
     ...
     * The plan to use.
     *
     * @var \HulkApps\ShopifyApp\Models\Plan
     */
    protected $plan;
     ...
     *
     * @param \HulkApps\ShopifyApp\Models\Shop $shop The shop to target for billing.
     * @param \HulkApps\ShopifyApp\Models\Plan $plan The plan from the database.
     *
     * @return self
     */
