...
namespace HulkApps\ShopifyApp\Middleware;
...
use HulkApps\ShopifyApp\Exceptions\MissingShopDomainException;
use HulkApps\ShopifyApp\Exceptions\SignatureVerificationException;
...
class AuthShop
{
     ...
     *
     * @param \Illuminate\Http\Request                  $request The request object.
     * @param \HulkApps\ShopifyApp\Services\ShopSession $session The shop session instance.
     *
     * @throws Exception
     *
     * @return bool|string
